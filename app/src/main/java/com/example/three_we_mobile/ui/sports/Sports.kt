package com.example.three_we_mobile.ui.sports
...
import com.example.three_we_mobile.utils.SPORTS_LINK

class Sports : Fragment() {

    companion object {
        fun newInstance() = Sports()
    }
    ...
    override fun onCreateView(
        ...
        fragView = inflater.inflate(R.layout.sports_fragment, container, false)
        initialize()
