package com.example.three_we_mobile.ui.horse
...
class Horse : Fragment() {
    ...
    override fun onCreateView(
        ...
        fragView = inflater.inflate(R.layout.horse_fragment, container, false)
        initialize()
