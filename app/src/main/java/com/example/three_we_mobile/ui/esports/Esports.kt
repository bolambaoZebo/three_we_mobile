package com.example.three_we_mobile.ui.esports
...
class Esports : Fragment() {
    ...
    override fun onCreateView(
        ...
        fragView = inflater.inflate(R.layout.esports_fragment, container, false)
        initialize()
