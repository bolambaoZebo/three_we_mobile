package com.example.three_we_mobile.ui.results
...
import com.example.three_we_mobile.utils.RESULT_4D_LINK

class Results : Fragment() {

    companion object {
        fun newInstance() = Results()
    }
    ...
    override fun onCreateView(
        ...
        fragView = inflater.inflate(R.layout.results_fragment, container, false)
        initialize()
    ...
    private fun appState(savedInstanceState: Bundle?){
        if (savedInstanceState != null){
            ...
            webView.loadUrl(RESULT_4D_LINK)
        }
    }
