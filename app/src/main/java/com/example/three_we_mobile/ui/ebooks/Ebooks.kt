package com.example.three_we_mobile.ui.ebooks
...
import com.example.three_we_mobile.utils.EBOOK_LINK
...
class Ebooks : Fragment() {
    ...
    companion object {
        fun newInstance() = Ebooks()
    }

    private lateinit var viewModel: EbooksViewModel
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProvider(this).get(EbooksViewModel::class.java)
    ...
    override fun onCreateView(
        ...
        fragView = inflater.inflate(R.layout.ebooks_fragment, container, false)
        initialize()
